...
colors:
  ...
  series-765: "oklch(0.67 0.19 8)"
  series-cg: "oklch(0.64 0.16 252)"
  series-ml: "oklch(0.75 0.15 76)"
  series-sidem: "oklch(0.65 0.15 148)"
  series-sc: "oklch(0.68 0.14 303)"
  series-gk: "oklch(0.64 0.19 35)"
...
设计的标志性元素是六系列并列形成的色带或真实图像墙。它只出现在品牌建立、导航定位或系列
归属确实有意义的位置；其余界面使用克制的中性色，让内容和操作优先。
