...
export type CommunityExchangeMeWorkspaceProps = {
  section?: ProfileWorkspaceSection
  sectionBasePath?: string
}

/**
 * Shared profile workspace view. It is not a route module, so both the
 * `/community/exchange/me` route element and the App account section page can
 * render it with explicit `section` props without going through the router's
 * component prop injection.
 */
export function CommunityExchangeMeWorkspace(
  props: CommunityExchangeMeWorkspaceProps = {}
) {
...
function ProfileWorkspace({
  ...
  sectionBasePath,
  platform,
}: CommunityExchangeMeWorkspaceProps & {
