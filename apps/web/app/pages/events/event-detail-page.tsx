    ...
    >
      ...
      {error ? (
        <Alert variant="destructive">
          <AlertTitle>无法读取社区动态</AlertTitle>
          <AlertDescription>该帖子不存在或尚未公开。</AlertDescription>
        </Alert>
      ) : null}
      {!loading && !error && !data ? (
        <Empty className="min-h-64 border">
          <EmptyHeader>
            <EmptyMedia />
            <EmptyTitle>未找到社区动态</EmptyTitle>
            <EmptyDescription>该帖子不存在或尚未公开。</EmptyDescription>
          </EmptyHeader>
        </Empty>
      ) : null}
