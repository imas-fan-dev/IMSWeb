...
const deleteRevisionResultSchema = z.object({
  success: z.literal(true),
  packageId: z.string().uuid(),
  revisionId: z.string().uuid(),
  revisionNumber: z.coerce.number().int().positive(),
...
const publicSitePackageSchema = z.object({
  slug: z.string(),
  title: z.string(),
  description: z.string(),
  revisionId: z.string().uuid(),
...
export function publishSitePackageRevision(
  ...
  return adminApiClient.Post<z.infer<typeof publishResultSchema>, unknown>(
...
export function deleteSitePackageRevision(
  ...
  return adminApiClient.Delete<
    z.infer<typeof deleteRevisionResultSchema>,
    unknown
  >(
    ...
    undefined,
    {
      meta: withBackofficeCsrf(),
      name: PUBLIC_CACHE_INVALIDATION_SOURCE.sitePackages,
      transform: (payload) => deleteRevisionResultSchema.parse(payload),
    }
  )
}
...
export function rotateSitePackagePreviewToken(
  ...
  return adminApiClient.Post<z.infer<typeof previewResultSchema>, unknown>(
