...
import { parseFudabaCardPlacement } from '@/domains/community/fudaba/cards/request';
import { fudabaCardPlacementView } from '@/domains/community/fudaba/cards/response';
