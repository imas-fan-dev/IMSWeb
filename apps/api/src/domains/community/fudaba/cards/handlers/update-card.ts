...
import { fudabaOwnerCardView, validFudabaCardId } from '@/domains/community/fudaba/contracts/card';
import { parseFudabaCardUpdate } from '@/domains/community/fudaba/cards/request';
