...
import type { ChronicleActivityParams } from '@/domains/content/chronicle/request';
import type { ChronicleActivityResponse } from '@/domains/content/chronicle/response';
import {
    chroniclePrefix,
