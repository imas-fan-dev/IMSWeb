...
function optionalText(
    ...
    return value === undefined
        ? undefined
        : requiredText(value, label, maximumLength);
}
...
function color(value: unknown, label: string, nullable = false): string | null {
...
function optionalHttpUrl(value: unknown): string | null {
    ...
    if (normalized.length > 2048)
        invalidRequest("Wiki 链接不能超过 2048 个字符");
    try {
...
export function validateCreateWikiAgencyRequest(
    value: unknown,
...
export function validateUpdateWikiAgencyRequest(
    value: unknown,
...
export function validateCreateWikiGroupRequest(
    value: unknown,
...
export function validateUpdateWikiGroupRequest(
    value: unknown,
...
export function validateWikiRevisionRequest(
    value: unknown,
): WikiRevisionRequest {
    return { expectedRevision: revision(jsonObject(value).expectedRevision) };
}

export function validateCreateWikiIdolRequest(
    value: unknown,
): CreateWikiIdolRequest {
    const body = jsonObject(value);
    const kind =
        body.entryKind === undefined ? "idol" : entryKind(body.entryKind);
...
export function validateUpdateWikiIdolRequest(
    value: unknown,
): UpdateWikiIdolRequest {
    const body = jsonObject(value);
    const kind =
        body.entryKind === undefined ? undefined : entryKind(body.entryKind);
    let subtype: WikiStoryEntrySubtype | null | undefined;
    if (body.entrySubtype === null) subtype = null;
    else if (body.entrySubtype !== undefined)
        subtype = entrySubtype(body.entrySubtype);
    if (
        kind !== undefined &&
        kind !== "story" &&
        subtype !== undefined &&
    ...
    return {
        ...
        textColor: optionalColor(body.textColor, "文字颜色") as
            | string
            | undefined,
...
export function validateCreateWikiCategoryRequest(
    value: unknown,
): CreateWikiCategoryRequest {
    return { name: requiredText(jsonObject(value).name, "分类名称") };
}

export function validateUpdateWikiCategoryRequest(
    value: unknown,
...
export function validateWikiStorySourcesRequest(
    value: unknown,
        ...
        description:
            body.description === undefined || body.description === null
                ...
                : typeof body.description === "string" &&
                    body.description.trim().length <= 240
...
function homepageUrl(value: unknown): string {
    ...
    try {
        ...
        if (
            ...
            error.message === "主页链接仅支持 HTTP 或 HTTPS"
        ) {
            throw error;
        }
        invalidRequest("主页链接无效");
...
export function validateWikiLayoutRequest(value: unknown): WikiLayoutRequest {
    ...
    return {
        ...
        groups: body.groups.map((value) => {
            ...
            if (
                idolIds.some(
                    (idolId) => !Number.isSafeInteger(idolId) || idolId <= 0,
                )
            ) {
...
export function validateWikiBilibiliRequest(
    value: unknown,
): WikiBilibiliRequest {
...
export const validateWikiMediaAgencyIdParams = wikiIdParams(
    "agencyId",
    "媒体实体",
);
export const validateWikiMediaGroupIdParams = wikiIdParams(
    "groupId",
    "媒体实体",
);
export const validateWikiMediaIdolIdParams = wikiIdParams("idolId", "媒体实体");

export function validateWikiCategoryCreateParams(
    value: unknown,
...
export function wikiValidationErrorBody(message: string): {
    status: string;
    msg: string;
} {
