...
export const DATABASE_PATH = configuredPath(
    'IMS_DB_PATH',
    path.join(LEGACY_DATA_DIR, 'core', 'news.db')
);
export const COMPENSATION_DIR = configuredPath(
    'IMS_COMPENSATION_DIR',
    path.join(LEGACY_DATA_DIR, 'core', 'compensation')
);
export const STORY_DATABASE_PATH = configuredPath(
    'IMS_STORY_DB_PATH',
    path.join(LEGACY_DATA_DIR, 'story', 'idol_data.db')
);
