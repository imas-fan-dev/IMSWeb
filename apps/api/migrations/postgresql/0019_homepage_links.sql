...
CREATE TABLE public.homepage_links (
    id TEXT PRIMARY KEY,
...
CREATE INDEX homepage_links_section_order_idx
    ON public.homepage_links(section, display_order, id);

INSERT INTO public.homepage_links
