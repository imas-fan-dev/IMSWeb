...
test.describe('Editorial', () => {
    ...
    test('mounted reads, assets, and spotlight responses preserve their raw JSON', async () => {
    ...
    test('admin middleware and conflict boundaries preserve exact JSON errors', async () => {
