...
test('migration catalog copies SQL files only before an existing boundary', async () => {
...
test('migration catalog fails before creating a fixture for a missing boundary', async () => {
