...
test.describe('Bilibili cover', () => {
    test('URLs are normalized and restricted to the image CDN', () => {
        assert.equal(
    ...
    test('download returns an upload-compatible image with bounded fetch options', async () => {
        let requestedUrl = '';
    ...
    test('download rejects unsupported and oversized responses', async () => {
