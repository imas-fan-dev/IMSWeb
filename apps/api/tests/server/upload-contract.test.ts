...
test.describe('upload contract', () => {
    ...
    test.describe('shared image upload contract', () => {
        test("rejects extension, MIME, decoded format, and corrupt payload mismatches", async () => {
        ...
        test("accepts standard HEIC and HEIF uploads", async () => {
            const body = new Uint8Array([1, 2, 3]);
