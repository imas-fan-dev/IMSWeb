...
test('[STATE-01] retired event write endpoints do not parse uploads or mutate records', async (t) => {
    const fixture = await createFixture(t);
    ...
    const responses = await Promise.all([
        fixture.request('/api/events', { method: 'POST', headers, body: '--contract--' }),
        fixture.request('/api/events/1', { method: 'PUT', headers, body: '--contract--' }),
        fixture.request('/api/events/1', { method: 'DELETE', headers })
    ]);
