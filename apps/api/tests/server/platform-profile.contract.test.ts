...
test.describe('platform profile contract', () => {
    ...
    test.describe('Platform avatar uploads', () => {
        test('spend a Platform budget, not the Fudaba one', async () => {
        ...
        test('ignore the Fudaba rollout switch', async () => {
            const fixture = new OwnerRouteFixture({
                publicReadEnabled: false,
                writeEnabled: false
            });
