...
test.describe('PostgreSQL migration', () => {
    ...
    test('catalog is available without a database connection', () => {
    ...
    test.describe('email', () => {
        ...
        test('request cooldown migration creates a narrow bounded anonymous store', {
            skip: !postgresIntegrationEnabled()
        }, async () => {
            const harness = await createPostgresTestHarness({
    ...
    test('names keep the frozen sequence and use UTC timestamps after it', () => {
    ...
    test.describe('runner', () => {
        test('is repeatable and rejects checksum drift', async () => {
        ...
        test('rejects an applied migration deleted from the catalog', async () => {
        ...
        test('rejects an applied migration renamed in the catalog', async () => {
