...
export const recommendationSchema = exactJsonResponse({ id: recommendationIdSchema, title: z.string().trim().min(1), thumbnail: z.string().nullable().optional(), content: z.string(), date: z.string().nullable().optional() })
