...
export const chronicleActivitySummarySchema = exactJsonResponse({ id: activityIdSchema, title: z.string().trim().min(1), date: z.string().trim().min(1), location: z.string().trim().min(1), cover: z.string().nullable() })
export const chronicleActivitySchema = exactJsonResponse({ id: activityIdSchema, title: z.string().trim().min(1), date: z.string().trim().min(1), location: z.string().trim().min(1), images: z.array(z.string().min(1)) })
